...
public class Playlist implements Serializable {
	...
	public void addTracks(List<FSMusicInfo> searchfsmusicinfos)
	{
		for (int i = 0; i < searchfsmusicinfos.size(); i++) {
			addTrack(searchfsmusicinfos.get(i));
		}
	 ...
	 */
	public void addTrack(FSMusicInfo fsmusicinfo) {
		PlaylistEntry playlistEntry = new PlaylistEntry();
//		playlistEntry.setAlbum(album);
//		playlistEntry.setTrack(track);

		playlistEntry.title=fsmusicinfo.title;
        
		playlistEntry.artist=fsmusicinfo.artist;
        
		playlistEntry.album=fsmusicinfo.album;
        
		playlistEntry.duration=fsmusicinfo.duration;
        
		playlistEntry.sourceUrlStr=fsmusicinfo.sourceUrlStr;
        
        
        
		//playlistEntry.curTime=fsmusicinfo.curTime;
        
		//playlistEntry.musicType=fsmusicinfo.musicType;
        
		playlistEntry.imageURLString=fsmusicinfo.imageURLString;
        
		playlistEntry.albumPictureUrlString=fsmusicinfo.albumPictureUrlString;
        
		playlistEntry.location=fsmusicinfo.location;
        
        
        
		playlistEntry.songId=fsmusicinfo.songId;
        
		playlistEntry.albumId=fsmusicinfo.albumId;
        
		playlistEntry.authorId=fsmusicinfo.authorId;
        
		playlistEntry.authorName=fsmusicinfo.authorName;
        
		playlistEntry.lrcLinkUrl=fsmusicinfo.lrcLinkUrl;
        
        
		playlistEntry.tryBeginTaskTimes=0;
        
        //   musicentity.id =fsmusicinfo.ID;
        
		//playlistEntry.name=fsmusicinfo.name;
        
        
		playlistEntry.speed=0L;
